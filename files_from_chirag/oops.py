...
#         self.age=age
#     def full_name(self):
#         return f"Your Full  details is {self.fname} {self.lname} {self.age}"
...
# chirag=Person("Chirag","Joshi",85)
# print(chirag.full_name())
# print(chirag.is_above18())
...
# class Car:
#     def __init__(self,car_name,car_model,price):
#         self_name.car=car_name
#         self.car_model=car_model
#         self.price=price

# audi=Car("Audi","Q7",500000)
# print(audi.car_name)
# print(audi.price)
# --------------------------------------------------------
# class Person:
...
#     @classmethod
#     def test(cls):
#         return " Hello i am class method"
